...
import (
	...
	"frpc-hub/internal/application/monitoring"
	"frpc-hub/internal/application/proxy"
	"frpc-hub/internal/application/server"
	"frpc-hub/internal/application/system"
	"frpc-hub/internal/application/version"
	"frpc-hub/internal/infrastructure/persistence"
	httphandler "frpc-hub/internal/interfaces/http"
	_ "frpc-hub/migrations"
