	...
	m.Register(func(app core.App) error {
		jsonData := `[
			...
			},
			{
				...
				"id": "_pb_users_auth_",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_tokenKey__pb_users_auth_` + "`" + ` ON ` + "`" + `fh_users` + "`" + ` (` + "`" + `tokenKey` + "`" + `)",
					"CREATE UNIQUE INDEX ` + "`" + `idx_email__pb_users_auth_` + "`" + ` ON ` + "`" + `fh_users` + "`" + ` (` + "`" + `email` + "`" + `) WHERE ` + "`" + `email` + "`" + ` != ''"
				],
			...
			},
			{
				...
				"id": "pbc_2245327697",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_gt75NqoejG` + "`" + ` ON ` + "`" + `fh_proxies` + "`" + ` (` + "`" + `serverId` + "`" + `)",
